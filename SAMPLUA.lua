...
function imgui.OnDrawFrame()
    if main_window_state.v then 
      ...
      imgui.Text(u8'Ñïðàâêà áîò ðåàãèðóåò íà ñëîâà: áîò ñëàï, áîò ëîïàòó, áîò ñïàâí')
      imgui.Text(u8'áîò ìàøèíó, áîò ëþêñ, áîò íðã, áîò ôëèï, áîò àá, áîò öð, áîò öá')
      imgui.Text(u8'áîò õï, áîò óíôðèç, áîò ìàâåðèê, áîò øàìàë, áîò ãèäðó, áîò áðîíèê.')
      imgui.End()
    end
  end
